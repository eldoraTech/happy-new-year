...
import ThreeDNumber from "../HeroText/ThreeDNumber";
...
export default function Card1() {
  ...
  useEffect(() => {
    (async () => {
      await happy.start((i) => letterVariants.show(i));
      await newWord.start((i) => letterVariants.show(i));
      await year.start((i) => letterVariants.show(i));
      await nums.start((i) => letterVariants.show(i));

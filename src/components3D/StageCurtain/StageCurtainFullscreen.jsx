...
export default function StageCurtainFullscreen() {
  ...
  useEffect(() => {
    ...
    const curtainWidth = viewWidth / 2;
    const curtainHeight = viewHeight; // ✅ 100% screen height
    ...
    /* ---------- ANIMATION ---------- */
    let progress = 0;
    const OPEN_DISTANCE = curtainWidth * 0.85;
    ...
    const animate = () => {
      ...
      leftCurtain.position.x =
        -curtainWidth / 2 - progress * OPEN_DISTANCE;
      rightCurtain.position.x =
        curtainWidth / 2 + progress * OPEN_DISTANCE;
